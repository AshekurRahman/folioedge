; (function ($) {
    $(document).on('ready', function () {
        ...
        /*====== service-2-testimonial-slider ======*/
        var testimonial_sider = new Swiper(".service-2-testimonial-slider", {
            loop: true,
            speed: 800,
            spaceBetween: 30,
            slidesPerView: 1,
            ...
            watchSlidesProgress: true,
            navigation: {
                nextEl: ".service-2-testimonial-slider .navigation-control .next",
                prevEl: ".service-2-testimonial-slider .navigation-control .prev",
            },
            breakpoints: {
                575: {
                    slidesPerView: 1,
